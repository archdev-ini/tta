...
export default function HomeClient({ marqueeText }: { marqueeText: string }) {
  ...
  return (
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <Marquee text={processedMarquee} className="bg-accent/5 text-accent border-y border-accent/10" repeat={4} />
      </motion.div>
